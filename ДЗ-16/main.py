...
while True:
    ...
    # Реализация товаров
        ...
        try:
            db.update_tn_sale_goods(tn_info[2], goods_id[0][0])
            ...
            print('='*100)
            continue
        db.insert_orders_sale(goods_id[0][0], customer[0][0], tn_info[2], tn_info[3], tn_info[4])
    ...
    # покупка товара у поставщика
        ...
        if goods_id:
            ...
            if db.check_categories(name_categories):
                tn_info.append(db.check_categories(name_categories)[0][0])
            else:
        ...
        if len(tn_info) == 5:
            ...
            goods_id = db.check_goods(tn_info[0])
            suppliers_id = db.check_suppliers(tn_info[-2])
            db.insert_orders_buy(goods_id[0][0], suppliers_id[0][0], tn_info[3], tn_info[1], tn_info[-1])
    ...
    # 3 - Отчет о движении денежных средств
        ...
        print(f'Текущий баланс: {db.get_balance()[0][0]}')
        ...
        while True:
            ...
            if cmd == "1":
                ...
                with open('transaction.txt', "w") as file_tr:
                    ...
                    file_tr.write(f'Текущий баланс: {db.get_balance()[0][0]}')
